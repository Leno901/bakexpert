...
const questions = [
  {
    question: "1. Which ingredient is NOT usually used in a traditional chiffon cake?",
    options: [
  ...
  {
    question: "2. Which of the following cakes has a moist crumb and intense chocolate flavor?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { answer: 'b) A ganache or frosting drip down the sides', isCorrect: true },
      { answer: 'c) A sculpted design', isCorrect: false },
      { answer: 'd) A fruit filling', isCorrect: false },
    ],
  },
  {
    question: "4. Which type of cake is typically used for celebrations and usually has multiple tiers?",
    options: [
  ...
  {
    question: "5. What is commonly applied to make thin designs and ornamentation on specialty cakes?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { answer: 'b) For achieving a flat surface so that layers could be placed evenly', isCorrect: true },
      { answer: 'c) To give flavor to the cake', isCorrect: false },
      { answer: 'd) To bake the cake uniformly', isCorrect: false },
    ],
  },
  {
    question: "7. Which cake is characterized with a light and airy texture, usually achieved by whipping egg whites?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { answer: 'b) To seal in crumbs before applying the final frosting', isCorrect: true },
      { answer: 'c) To decorate the cake', isCorrect: false },
      { answer: 'd) To make the cake taller', isCorrect: false },
    ],
  },
  {
    question: "10. Which tool is used to create smooth, even layers of frosting?",
    options: [
  ...
  {
    question: "12. Which of the following cakes is characterized by a dense texture and often inclusion of nuts and spices?",
    options: [

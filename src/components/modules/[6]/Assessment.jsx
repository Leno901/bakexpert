...
const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        answer: "b) To react with an acid to create carbon dioxide",
        isCorrect: true,
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        answer: "b) To provide both acid and base for leavening",
        isCorrect: true,
      },
      { answer: "c) To add color", isCorrect: false },
      { answer: "d) To make the bread more dense", isCorrect: false },
  ...
  {
    question:
      "7. What is a common acid ingredient that reacts with baking soda in quick breads?",
    options: [
  ...
  {
    question:
      "9. What is one typical technique for incorporating moisture into quick bread?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      {
        answer: "b) Yes, they can be stored for several days",
        isCorrect: true,
      },

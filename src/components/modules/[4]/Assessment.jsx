...
const questions = [
  ...
  {
    question: "5. The sponge cake for a Swiss roll is typically baked in what type of pan?",
    options: [
  ...
  {
    question: "8. What is often used to prevent the Swiss roll from sticking to the baking sheet?",
    options: [
  ...
  {
    question: "12. What ingredient helps to create a light and airy sponge in a Swiss roll?",
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { answer: 'b) Yes, it can be prepared a day or two in advance', isCorrect: true },
